    ...
    implements ProtocolIcon
{
    ...
    static
    {
        iconPathsTable.put(ProtocolIcon.ICON_SIZE_16x16,
            getResources().getImagePath("service.protocol.aim.AIM_16x16"));

        iconPathsTable.put(ProtocolIcon.ICON_SIZE_32x32,
            getResources().getImagePath("service.protocol.aim.AIM_32x32"));

        iconPathsTable.put(ProtocolIcon.ICON_SIZE_48x48,
            getResources().getImagePath("service.protocol.aim.AIM_48x48"));

        iconPathsTable.put(ProtocolIcon.ICON_SIZE_64x64,
            getResources().getImagePath("service.protocol.aim.AIM_64x64"));
    }
